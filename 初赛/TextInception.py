...
embedder = Embedding(353717+1, 378, input_length = MAX_LENGTH)
embed = embedder(main_input)

# cnn1模块，kernel_size = 3
conv1_1 = Convolution1D(256, 1, padding='same')(embed)
...
bn3_1 = BatchNormalization()(conv2_1)
relu3_1 = Activation('relu')(bn2_1)
conv3_2 = Convolution1D(128, 5, padding='same')(relu2_1)

conv4_1 = Convolution1D(256, 3, padding='same')(embed)

# 拼接三个模块
cnn = concatenate([conv1_1,conv2_2,conv3_2,conv4_1], axis=-1)
flat = Flatten()(cnn)
mlp = BatchNormalization()(flat)
relu = Activation('relu')(mlp)

#drop = Dropout(0.7)(flat)
main_output = Dense(125, activation='softmax')(relu)
...
name = 'incepetion_' + str(history.history['f1'][-1])[2:]+'.h5'
model.save(name)
